...
public class Treap<E extends Comparable<E>>{
	...
	/**
	 * Creates new Treap with null root and random unseeded priorityGenerator
	 */
	public Treap() {
		root = null;
	...
	/**
	 * Creates new Treap with null root and random seeded priorityGenerator
	 * @param seed The long seed placed inside the random priorityGenerator
	 */
	 ...
	 * @param curr Reference to current node, the one that caused a problem in the heap structure
	 * @param path Reference to path of nodes in a stack, leading to the root of the tree, allowing for references to parent nodes of curr
	 */
	 ...
	 * @param key Argument for the key of the node that will be added to the 
	 * @param priority Randomly generated heap priority of new node being added
	 * @return boolean value for sucessful addition
	 */
	 ...
	 * @param key Key of the node being added, function calls priorityGenerator to create random heap priority
	...
	/**
	 * Private helper function that is called by public delete function, performs the actual deleting
	 ...
	 * @param key Reference to the key being searched for inside the Treap
	 * calls the function with a reference to the root node of the Treap
	 * @return boolean value for found or not
	 */
